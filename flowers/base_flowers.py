...
def main():
    ...
    Train_dataset = CustomDataset(train_data, transform=TwoCropsTransform(transforms.Compose(augmentation)))
    ...
    wandb.alert(
        title='学習が完了しました。',
        text=f'final_loss :{loss} final_knn_acc :{knn_acc} final_linear_acc :{linear_acc}'
    )
